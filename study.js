...
const goldsmithTest = new lab.html.Form({
  content:
    ...
    '<p class="text-center">Before finishing, we would like to learn a bit more about you.</p>' +
    "" +
    '<form id="goldmsi">' +
    "      <table>" +
    ...
    '<tr style="height: 100px">' +
    '<td class="font-weight-bold">' +
    "I have attended __ live music events as an audience member in the past twelve months." +
    "</td>" +
    "<td>" +
